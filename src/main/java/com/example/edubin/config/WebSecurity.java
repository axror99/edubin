...
//                    configuration.setAllowedOriginPatterns(List.of("https://edubin-axror.herokuapp.com/"));
...
//                .requestMatchers("/api/course/**").permitAll()
                ...
                .requestMatchers("/api/course/get/**").permitAll()
                .requestMatchers("/api/course/recommend/list").permitAll()
                .requestMatchers("/api/course/list/page/*").permitAll()
...
//                .requestMatchers("/api/employee/**").permitAll()
                ...
                .requestMatchers("/api/employee/listTeacher/page/**").permitAll()
                .requestMatchers("/api/employee/update/himself/**").permitAll()
                .requestMatchers("/api/employee/teacher/**").permitAll()
                .requestMatchers("/api/email/**").permitAll()
                .requestMatchers("/api/auth/**").permitAll()
                .requestMatchers("/api/product/**").permitAll()
                .requestMatchers("/api/product/list/page/**").permitAll()
                .requestMatchers("/api/product/list/recommend").permitAll()
